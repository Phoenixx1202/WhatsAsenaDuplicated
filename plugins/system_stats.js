...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'status', fromMe: true, desc: Lang.ALIVE_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'status', fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'status', fromMe: true, desc: Lang.ALIVE_DESC, dontAddCommandList: true}, (async (message, match) => {
